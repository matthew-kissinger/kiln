...
**[matthew-kissinger.github.io/kiln](https://matthew-kissinger.github.io/kiln/)**, alongside the
install steps for each harness. Open [any specimen](https://matthew-kissinger.github.io/kiln/#/gallery)
to orbit it, flip it to wireframe to see the topology under the shading, or pull the GLB down and
open it in whatever you use. That site holds no assets either: its build runs the same programs
through the same evaluator, so what you orbit there is what the file beside it produces today
rather than an export somebody remembered to refresh. It lives in [`site/`](site).
