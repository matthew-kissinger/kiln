...
export const OPTIMIZED_PALETTE: readonly PaletteSlot[] = [
  { index: 0, name: 'steel', color: '#8a8f99', metalness: 0.9, roughness: 0.5, use: 'bare metal, blades, machinery, hulls' },
  { index: 1, name: 'gunmetal', color: '#3a3f47', metalness: 0.9, roughness: 0.45, use: 'dark metal, weapons, iron fittings' },
  { index: 2, name: 'brass', color: '#c8a64b', metalness: 0.95, roughness: 0.4, use: 'gold/brass trim, horns, ornament' },
  { index: 3, name: 'copper', color: '#b06a3a', metalness: 0.9, roughness: 0.45, use: 'copper/bronze, worn metal' },
  { index: 4, name: 'wood', color: '#9a6a3c', metalness: 0.0, roughness: 0.8, use: 'planks, handles, crates, trunks' },
  { index: 5, name: 'dark-wood', color: '#5a3a22', metalness: 0.0, roughness: 0.8, use: 'aged timber, bark, framing' },
  { index: 6, name: 'stone', color: '#8d8a82', metalness: 0.0, roughness: 0.95, use: 'rock, masonry, boulders' },
  { index: 7, name: 'concrete', color: '#b8b4ad', metalness: 0.0, roughness: 0.95, use: 'concrete, plaster, pale walls' },
  { index: 8, name: 'brick', color: '#9e4b34', metalness: 0.0, roughness: 0.9, use: 'brick, terracotta, clay' },
  { index: 9, name: 'sand', color: '#cdb27a', metalness: 0.0, roughness: 1.0, use: 'sand, adobe, tan earth' },
  { index: 10, name: 'dirt', color: '#5b4632', metalness: 0.0, roughness: 1.0, use: 'soil, mud, dark ground' },
  { index: 11, name: 'foliage', color: '#4f8f3f', metalness: 0.0, roughness: 0.9, use: 'leaves, grass, plants' },
  { index: 12, name: 'glass', color: '#aacbe0', metalness: 0.0, roughness: 0.1, transparent: true, opacity: 0.35, use: 'windows, lenses — the ONE transparent slot' },
  { index: 13, name: 'white', color: '#e8e8e6', metalness: 0.0, roughness: 0.7, use: 'white paint, cloth, paper' },
  { index: 14, name: 'black', color: '#1a1c1f', metalness: 0.0, roughness: 0.6, use: 'black, rubber, charred, tires' },
  { index: 15, name: 'accent-warm', color: '#c0392b', metalness: 0.0, roughness: 0.7, use: 'red/orange paint, flags, signs' },
  { index: 16, name: 'accent-cool', color: '#2f6fd0', metalness: 0.0, roughness: 0.7, use: 'blue/teal paint, water, signs' },
  { index: 17, name: 'skin', color: '#c8946a', metalness: 0.0, roughness: 0.75, use: 'character skin / flesh' },
  { index: 18, name: 'glow', color: '#ffd9a0', metalness: 0.0, roughness: 1.0, emissive: true, use: 'lamps, neon, fire cores, vfx — the ONE emissive slot' },
];
