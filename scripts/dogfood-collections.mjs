...
const prompt = [
  ...
  'Use kiln_discover with natural-language queries to find useful helpers and optional recipes; fetch exact ids for complete contracts before unfamiliar calls. Author, render, look at images when your harness delivers them, and repair visible problems. Do not claim you saw an image if you only received a file path. Check viewFidelity before judging materials.',
