...
function build() {
  ...
  for(let i=0;i<64;i++)for(let j=0;j<4;j++){const a=4*i+j,b=4*i+(j+1)%4,c=4*(i+1)+(j+1)%4,d=4*(i+1)+j;di.push(a,c,d,a,b,c);}
  di.push(0,2,1,0,3,2,256,257,258,256,258,259);
