...
function build() {
  ...
  function makeWing(name, px, pz, span, rootChord, tipChord, sweep, mirror) {
    ...
    // brass leading-edge spar + 2 veins (right side coords; mirrored via pivot rotation)
  ...
  makeWing('WingFrontR', 0.22, 0.09, 0.68, 0.22, 0.08, 0.22, false);
  makeWing('WingFrontL', 0.22, -0.09, 0.68, 0.22, 0.08, 0.22, true);
  makeWing('WingRearR', 0.0, 0.09, 0.58, 0.18, 0.07, 0.18, false);
  makeWing('WingRearL', 0.0, -0.09, 0.58, 0.18, 0.07, 0.18, true);
