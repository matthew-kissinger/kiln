...
function build(){
 ...
 add("Arm_hull_mounting_plate",boxGeo(.26,.06,.23),teal,[.28,.82,.49],root,[12,0,0]);
 beam("Shoulder_mount_forward",[.39,.84,.50],ARM_ROOT,.033,steel);
 beam("Shoulder_mount_aft",[.17,.84,.50],ARM_ROOT,.033,steel);
 ...
 pipe("Shoulder_rotating_service_loop",[[-.045,0,.087],[-.06,.09,.087],[.075,.10,.087],[.10,.045,.087],[.37,.045,.087],[.43,0,.087]],.009,black,shoulder);
 ...
 pipe("Hull_to_shoulder_feed",[[.15,.96,.53],[.10,.83,.65],[ARM_ROOT[0],ARM_ROOT[1],ARM_ROOT[2]+.087]],.012,black);
